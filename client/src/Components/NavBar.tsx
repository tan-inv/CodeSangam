        ...
        <div className="flex flex-wrap items-center justify-between pt-0 p-4 mt-0 m-3">
          ...
          <div className="flex justify-between md:order-2">
            <a
              ...
              style={{ fontSize: "75%" }}
              type="button"
              className="card text-blue-500 event-selected border-2 rounded-t-lg inline-block p-2 md:hover:text-blue-500"
            >
              DASHBOARD
            </a>
            <button
              ...
              type="button"
              className="inline-flex items-center border-2 ml-4 p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden focus:outline-none"
